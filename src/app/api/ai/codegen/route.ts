...
const DESIGN_PERSONAS = [
    {
        id: "cyberpunk",
        name: "The Futurist (Cyberpunk/Web3)",
        description: "Dark mode only. Neon accents (#00f3ff, #bd00ff). Glitch effects. Glassmorphism borders. Audiowide/Space Grotesk fonts.",
        css: "bg-slate-950 text-slate-50 selection:bg-cyan-500/30",
        components: "Sharp edges, glow effects, holographic cards."
    },
    {
        id: "swiss",
        name: "The Swiss (International Typographic)",
        description: "High contrast. Black & White dominant. Massive typography (Helvetica/Inter). Grid lines visible. Asymmetric layouts.",
        css: "bg-white text-black selection:bg-black selection:text-white",
        components: "Thick borders (border-2 border-black), brutalist buttons, raw aesthetic."
    },
    {
        id: "neo-brutalism",
        name: "Neo-Brutalism (Gumroad/Figma)",
        description: "Pastel background (bg-yellow-50). High contrast black borders with hard shadows (shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]).",
        css: "bg-[#fdf6e3] text-slate-900",
        components: "Retro-modern, playful, high-saturation accents."
    },
    {
        id: "corporate",
        name: "The Enterprise (Stripe/Linear)",
        description: "Clean, trustworthy. Slate-50 background. Blue-600 primary. Subtle gradients. Rounded-2xl corners.",
        css: "bg-slate-50/50 text-slate-900",
        components: "Soft shadows (shadow-xl), frosted glass, micro-interactions."
    },
    {
        id: "minimal",
        name: "The Essentialist (Notion/Apple)",
        description: "Pure white/gray. Serif headings (Merriweather/Playfair). Lots of whitespace. No shadows, just borders.",
        css: "bg-white text-stone-800",
        components: "Minimalist, focus on typography and spacing."
    }
];
...
@layer base { * { @apply border-border; } body { @apply bg-background text-foreground min-h-screen; } }`
  ...
  try {
    ...
    **YOU MUST STRICTLY ADHERE TO THIS STYLE.**
    - **Visual Vibe**: ${selectedPersona.description}
    - **Component Style**: ${selectedPersona.components}
    - **Color Palette**: ${selectedPersona.css}
    
    **DO NOT DEVIATE.** If the persona says "Cyberpunk", do NOT make a white clean corporate site.
    
    --------------------------------------------------------------------------------
    ### 2. ARCHITECTURE & FILE STRUCTURE
    You are a Senior Architect. Do NOT dump code into one file. Split logic intelligently.

    **MANDATORY FILE STRUCTURE (For Landing Pages)**:
    ...
    **EXCEPTION FOR WEB APPS (SaaS/Dashboards)**:
    ...
    4.  \`src/components/dashboard/editor.tsx\` (or relevant tool) -> The core feature.
    ...
    - **SOURCE**: Use high-quality Unsplash URLs matching the vibe.
      - Tech/Cyberpunk: \`https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=800\`
      - Minimal/Clean: \`https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?auto=format&fit=crop&q=80&w=800\`
      - Business: \`https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&q=80&w=800\`
